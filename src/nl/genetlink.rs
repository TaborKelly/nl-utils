...
#[repr(C)]
#[derive(Copy)]
pub struct Struct_genlmsghdr {
    pub cmd: __u8,
    pub version: __u8,
    pub reserved: __u16,
}
impl ::std::clone::Clone for Struct_genlmsghdr {
    fn clone(&self) -> Self { *self }
}
impl ::std::default::Default for Struct_genlmsghdr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type Enum_Unnamed4 = ::libc::c_uint;
pub const CTRL_CMD_UNSPEC: ::libc::c_uint = 0;
pub const CTRL_CMD_NEWFAMILY: ::libc::c_uint = 1;
pub const CTRL_CMD_DELFAMILY: ::libc::c_uint = 2;
pub const CTRL_CMD_GETFAMILY: ::libc::c_uint = 3;
pub const CTRL_CMD_NEWOPS: ::libc::c_uint = 4;
pub const CTRL_CMD_DELOPS: ::libc::c_uint = 5;
pub const CTRL_CMD_GETOPS: ::libc::c_uint = 6;
pub const CTRL_CMD_NEWMCAST_GRP: ::libc::c_uint = 7;
pub const CTRL_CMD_DELMCAST_GRP: ::libc::c_uint = 8;
pub const CTRL_CMD_GETMCAST_GRP: ::libc::c_uint = 9;
pub const __CTRL_CMD_MAX: ::libc::c_uint = 10;
pub type Enum_Unnamed5 = ::libc::c_uint;
pub const CTRL_ATTR_UNSPEC: ::libc::c_uint = 0;
pub const CTRL_ATTR_FAMILY_ID: ::libc::c_uint = 1;
pub const CTRL_ATTR_FAMILY_NAME: ::libc::c_uint = 2;
pub const CTRL_ATTR_VERSION: ::libc::c_uint = 3;
pub const CTRL_ATTR_HDRSIZE: ::libc::c_uint = 4;
pub const CTRL_ATTR_MAXATTR: ::libc::c_uint = 5;
pub const CTRL_ATTR_OPS: ::libc::c_uint = 6;
pub const CTRL_ATTR_MCAST_GROUPS: ::libc::c_uint = 7;
pub const __CTRL_ATTR_MAX: ::libc::c_uint = 8;
pub type Enum_Unnamed6 = ::libc::c_uint;
pub const CTRL_ATTR_OP_UNSPEC: ::libc::c_uint = 0;
pub const CTRL_ATTR_OP_ID: ::libc::c_uint = 1;
pub const CTRL_ATTR_OP_FLAGS: ::libc::c_uint = 2;
pub const __CTRL_ATTR_OP_MAX: ::libc::c_uint = 3;
pub type Enum_Unnamed7 = ::libc::c_uint;
pub const CTRL_ATTR_MCAST_GRP_UNSPEC: ::libc::c_uint = 0;
pub const CTRL_ATTR_MCAST_GRP_NAME: ::libc::c_uint = 1;
pub const CTRL_ATTR_MCAST_GRP_ID: ::libc::c_uint = 2;
pub const __CTRL_ATTR_MCAST_GRP_MAX: ::libc::c_uint = 3;
